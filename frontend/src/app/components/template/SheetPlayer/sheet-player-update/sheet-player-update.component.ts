...
@Component({
  selector: 'app-sheet-player-update',
  templateUrl: './sheet-player-update.component.html',
  styleUrls: ['./sheet-player-update.component.css']
})
export class SheetPlayerUpdateComponent implements OnInit {
